...
namespace InventarioSalidas
{
    public partial class FormHistorial : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.MinimumSize = new Size(800, 600); // Tamaño mínimo para evitar que se vea muy pequeño

            // ========== PANEL HEADER ==========
            panelHeader = new Panel();
            panelHeader.Dock = DockStyle.Top; // Ya estaba bien con Dock
            ...
            lblTitulo.Anchor = AnchorStyles.Left | AnchorStyles.Top; // Se mantiene en su posición
            ...
            panelFiltros.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right; // Se estira horizontalmente
            ...
            lblBuscar.Anchor = AnchorStyles.Left | AnchorStyles.Top;
            ...
            txtBuscar.Anchor = AnchorStyles.Left | AnchorStyles.Top;
            ...
            lblDesde.Anchor = AnchorStyles.Left | AnchorStyles.Top;
            ...
            dtpDesde.Anchor = AnchorStyles.Left | AnchorStyles.Top;
            ...
            lblHasta.Anchor = AnchorStyles.Left | AnchorStyles.Top;
            ...
            dtpHasta.Anchor = AnchorStyles.Left | AnchorStyles.Top;
            ...
            btnLimpiarFiltro.Anchor = AnchorStyles.Right | AnchorStyles.Top; // Se mueve con el borde derecho
            panelFiltros.Controls.Add(btnLimpiarFiltro);

            // Botón Filtrar (va después para que se ancle relativo al botón Limpiar)
            btnFiltrar = new Button();
            btnFiltrar.Text = "🔎 Filtrar";
            btnFiltrar.Location = new Point(btnLimpiarFiltro.Left - 130, 12); // 130 = 120 (ancho) + 10 (espacio)
            ...
            btnFiltrar.Anchor = AnchorStyles.Right | AnchorStyles.Top; // También se mueve con el borde derecho
            ...
            lblTotal.Anchor = AnchorStyles.Left | AnchorStyles.Top;
            ...
            // CRÍTICO: Anclar en las 4 direcciones para que crezca con el formulario
            ...
            btnActualizar.Anchor = AnchorStyles.Bottom | AnchorStyles.Right; // Se queda abajo a la derecha
            ...
            btnCerrar.Anchor = AnchorStyles.Bottom | AnchorStyles.Right; // Se queda abajo a la derecha
